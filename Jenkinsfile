    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-qemu-static/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-qemu-static\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-qemu-static\" \
          ...
          --label \"org.opencontainers.image.description=Run multiple architectures of Docker containers on an x86_64 or aarch64 host using QEMU static.\" \
